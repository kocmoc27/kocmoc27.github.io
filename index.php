		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 col-md-pull-4 animation_2">
					...
					<p></p>
					<p>В 2012 году закончил ЮУРГУ факультет Экономика и управление, кафедра Информатика и... ушел в бизнес. В 2017 году самостоятельно изучал фронтенд/бекэнд программирование, а также интернет маркетинг. Освоил базовое применение во фронтнеде: HTML5, CSS3, JavaScript, jQuery, сетку Bootstrap 3,4. Использовал node js, gulp и Sass для верстки. Бэкенд: Php, mySQL, AJAX. Имею представление о принципах ООП, шаблоне MVC. Есть опыт использование GIT</p> 
				</div>
				...
				<div class="col-md-4 animation_3 personal_last_block">
					...
					<div class="social_wrap">
						<ul>
							...
							<li><a href="https://vk.com/kcm27" target="_blanc"><i class="fa fa-vk"></i></a></li>
							<li><a href="https://youtube.com" target="_blanc"><i class="fa fa-youtube"></i></a></li>
							<li><a href="https://github.com/kocmoc27" target="_blanc"><i class="fa fa-github"></i></a></li>
						</ul>
					</div>
				</div>	
			</div>
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					...
					<form class="main_form" action="https://formspree.io/bnk40191@gmail.com" method="post" novalidate>
						<label class="form-group">
							...
							<textarea name="" id="" cols="30" rows="3" placeholder="Ваше сообщение" reqired></textarea>
						</label>
...
<footer class="main_footer bg_dark">
	...
	<div class="social_wrap">
		<ul>
			<li><a href="https://www.facebook.com" target="_blanc"><i class="fa fa-facebook"></i></a></li>
			<li><a href="vk.com/kcm27" target="_blanc"><i class="fa fa-vk"></i></a></li>
			<li><a href="" target="_blanc"><i class="fa fa-youtube"></i></a></li>
			<li><a href="https://github.com/kocmoc27"><i class="fa fa-github"></i></a></li>
		</ul>
	</div>
